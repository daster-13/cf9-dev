...
public class FileWritersJavaIo {
    public static void main(String[] args) {
        ...
        try (PrintStream ps = new PrintStream("C:/Users/a8ana/IdeaProjects/CodingFactory9/src/gr/aueb/cf/cf9/ch9/file.txt")) {
...
//            bufferedWriter(file);
            ...
            System.out.println("Το αρχείο δεν δημιουτγήθηκε ή κάποιο λάθος συνέβη κατα την εγγραφή");
        }
    }
    ...
    public static void sayHello(PrintStream ps) throws IOException{
